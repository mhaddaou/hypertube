      ...
      <div className="w-full bg-[#22242A] pt-14">
        <div className="container w-full">
          ...
          <div className="flex justify-center gap-6 pb-10 pt-14">
            <div className="w-[355px] h-[310px] bg-black rounded-2xl flex flex-col items-center justify-around">
              <Image src="images/icons/tv.svg" alt="" width={200} height={10} />
        ...
        <div className="w-full bg-black/20  relative ">
            <div className="absolute bottom-0 left-0 ">
                <Image src='/images/icons/footerD.svg' alt="" width={350} height={500} />
            </div>
            <div className="w-full bg--600 container bg--500">
                <div className="flex justify-between items-center">
                    <div className="w-1/2">
                        <Image src='/images/icons/logo.svg' alt="" width={200} height={10}/>
                ...
                <div className="flex py-10 w-full justify-between">
                  <div className="text-black relative">
                    <p className="text-[#22242A] font-lexend-Deca font-semibold">Follow</p>
                  </div>
                  <div className="flex gap-5">
                    <button className=" font-lexend-Deca px-6 py-2  text-sm rounded-full border-[1.5px]">Sing In</button>
                    <button className="bg-color-primary text-black font-lexend-Deca px-6 py-2 text-sm rounded-full">Register</button>
                  </div>
